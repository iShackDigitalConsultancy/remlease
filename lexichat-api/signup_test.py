...
TEST_EMAIL = "phase2test2@ishack.co.za"
TEST_PASSWORD = "Password123!"

res = requests.post(f"{URL}/api/auth/signup", json={"email": TEST_EMAIL, "password": TEST_PASSWORD, "firm_name": "Phase 2 Testers", "full_name": "Tester", "is_firm_admin": True})
print("Signup Response:", res.status_code, res.text)
if res.status_code != 200 and "Email already registered" not in res.text:
    exit(1)
